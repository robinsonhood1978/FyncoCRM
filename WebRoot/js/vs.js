...
function vlstatInitLE(arrIp) {
	//var returnCitySN = {"cip": "27.252.63.211", "cid": "NZ", "cname": "NEW ZEALAND"};
	//alert("oo");
    var p;
...
// 
    ...
    var vlstatIPAddress = arrIp["cip"];
    var cid = arrIp["cid"];
    var cname = arrIp["cname"];
    ...
    p = "ua=" + vlstatUA + "&ip=" + vlstatIPAddress+ "&cid=" + cid+ "&cname=" + cname + "&refurl="
            ...
            + "&os=" + vlstatOS + "&brower=" + vlstatBrower  ;
    //+ "&browerLang=" + vlstatBrowerLanguage
    //+ "&title=" + vlstatPageTitle+ "&ch=" + vlstatCH + "&ch1=" + vlstatCH1 + "&ch2=" + vlstatCH2 + "&ch3=" + vlstatCH3
